...
function Contribute() {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4">Contribute to Fundraise</h1>
      <div className="form-control mb-4">
        <label className="label">
          <span className="label-text">Fundraise ID</span>
        </label>
        <input
          type="number"
          placeholder="Enter fundraise ID"
          className="input input-bordered"
          value={fundraiseId}
          onChange={e => setFundraiseId(e.target.value)}
        />
      </div>
      <div className="form-control mb-4">
        <label className="label">
        ...
        <div className="flex-grow bg-base-300 w-full mt-16 px-8 py-12">
          <div className="flex justify-center items-center gap-12 flex-col sm:flex-row">
            <div className="flex flex-col bg-base-100 px-10 py-10 text-center items-center max-w-xs rounded-3xl">
              <CreateFundraise></CreateFundraise>
            </div>
            <div className="flex flex-col bg-base-100 px-10 py-10 text-center items-center max-w-xs rounded-3xl">
